...
.alert-info {{ background-color: #EFF6FF; color: #1E40AF !important; border: 1px solid #DBEAFE; }}
...
def append_asistencia_personas(fecha, centro, espacio, nombre, estado, es_nuevo, coordinador, usuario, notas=""):
    ...
    # 🚨 Corrección 1: Usando ASISTENCIA_PERSONAS_TAB
